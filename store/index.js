export const state = () => ({
  ...
  lesnoi: {
    ...
    helloTextMain: 'Приветствую вас на портале «Умный город Росатома- Лесной»!\n' +
  ...
  novouralsk: {
    ...
    helloTextMain: 'Перед вами портал «Умный город Росатома — Новоуральск». \n' +
  ...
  zarechniiSverdl: {
    ...
    helloTextMain: 'Перед вами портал «Умный город Росатома - Заречный». Здесь представлен' +
  ...
  trehgornii: {
    ...
    helloTextMain: 'Перед вами портал «Умный город Росатома — Трехгорный». \n' +
